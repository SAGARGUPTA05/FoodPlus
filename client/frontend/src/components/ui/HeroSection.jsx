...
function HeroSection() {
  ...
  return (
    <div className={`${theme=="light" ?'bg-white' :'bg-[#121212]'} flex flex-col md:flex-row max-w-7xl mx-auto md:p-10 rounded-lg items-center justify-center m-4 gap-20 `}>
      <div className="flex flex-col gap-10 md:w-[40%] ">
        <div className="flex flex-col gap-5">
          <p className={`font-bold md:font-extrabold md:text-5xl text-4xl  ${theme=="light" ?'text-[#213547]' :'text-[#E0E0E0]'} `}>
        ...
        <div className="relative flex items-center justify-between gap-2  z-0 ">
          <input
            ...
            className={`pl-10 shadow-lg h-12 w-72  ${theme=="light" ?'text-[#213547]' :'text-[#E0E0E0]'}`}
          />
